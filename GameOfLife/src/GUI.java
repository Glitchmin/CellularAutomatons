...
public class GUI extends JPanel implements ActionListener, ChangeListener {
    ...
    public void initialize(Container container) {
        ...
        rainCheckBox.setToolTipText("Switches to rain simulation");
        rainCheckBox.setActionCommand("rainCheckBox");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(timer)) {
            ...
            if (Point.getIsRain()){
                frame.setTitle("Game of Rain :P (" + Integer.toString(iterNum) + " iteration)");
            }
            board.iteration();
        } else {
